(() => {
  const translations = {
    es: {
      ...
      tab_descriptions: "Contenido de productos",
      tab_cip: "Registro de ingenieros",
      ...
      tool_ai_proof: "Contenido de productos + registro de ingenieros",
    ...
    en: {
      ...
      tab_descriptions: "Product content",
      tab_cip: "Engineers registry",
      ...
      tool_ai_proof: "Product content + engineers registry",
      tool_code_title: "Software",
  ...
  const caseRecords = {
    ...
    descriptions: {
      ...
      es: {
        ...
        state: "JOB CLOUD",
        title: "Contenido de productos: de A360 a Python",
        lede: "Migración del proceso que genera nombres, descripciones y HTML para el catálogo usando OpenAI API.",
      ...
      en: {
        ...
        state: "CLOUD JOB",
        title: "Product content: from A360 to Python",
        lede: "Migration of the process that generates product names, descriptions, and HTML using OpenAI API.",
        outcome: "Python 3.12 + OpenAI API + Cloud Run Job",
    ...
    cip: {
      ...
      es: {
        ...
        title: "Consulta del registro de ingenieros con Gemini Vision",
        lede: "API que consulta el registro público del Colegio de Ingenieros del Perú mediante navegador automatizado y resolución visual del captcha.",
      ...
      en: {
        ...
        state: "CLOUD SERVICE",
        title: "Engineers registry lookup with Gemini Vision",
        lede: "API that queries the public registry of the Colegio de Ingenieros del Perú through browser automation and visual captcha resolution.",
        outcome: "FastAPI + Playwright + Gemini Vision",
