const translations = {
  en: {
    ...
    hero_title: "AI Automation Specialist · RPA, OpenAI API and cloud jobs in production",
    hero_sub: "Computer Science graduate in Lima. I build and validate production automation: A360 bots, REST integrations, Oracle queries, .NET jobs on GCP Cloud Run, and OpenAI API workflows. <strong>13 shipped automations with ROI tracked.</strong>",
    ...
    exp_p_a1: "<strong>Integrated OpenAI API with A360</strong> for web content and SEO workflows, freeing <strong>1,800+ hours</strong> of manual writing work.",
    ...
    exp_p_a3: "<strong>Mitigated ~$53,333 USD in promotion configuration risk</strong> by defining business rules and validating the upload flow.",
    ...
    proj1_badge: "Cloud job",
    proj1_title: "PO Generation - GCP Cloud Run",
    proj1_desc: "Moved purchase-order generation from RPA into a Cloud Run Job with .NET, Azure DevOps CI/CD, and Microsoft Graph API integration. Shipped in <strong>2.5 weeks</strong>.",
    proj2_badge: "Risk control",
    proj2_title: "Promotions Upload - Business Rule Validation",
    proj2_desc: "Defined the rules and QA path for a promotions upload flow after manual configuration errors caused ~S/ 200,000 in losses.",
    ...
    proj7_desc: "Built and deployed a full-stack SaaS for installment payment management: <strong>React 18 + Node.js + PostgreSQL</strong> on <strong>Cloudflare Pages + GCP Cloud Run</strong>, with CI/CD and automated backups.",
    skills_tag: "Working Stack",
    skills_title: "Tools I can defend in an interview",
  ...
  es: {
    ...
    hero_title: "Especialista en Automatización con IA · RPA, OpenAI API y jobs cloud en producción",
    hero_sub: "Licenciado en Ciencias de la Computación en Lima. Construyo y valido automatización en producción: bots A360, integraciones REST, consultas Oracle, jobs .NET en GCP Cloud Run y flujos con OpenAI API. <strong>13 automatizaciones entregadas con ROI trazado.</strong>",
    ...
    exp_p_a1: "<strong>Integré OpenAI API con A360</strong> para flujos de contenido web y SEO, liberando <strong>1,800+ horas</strong> de redacción manual.",
    ...
    exp_p_a3: "<strong>Mitigué ~$53,333 USD en riesgo por configuración de promociones</strong> definiendo reglas de negocio y validando el flujo de carga.",
    ...
    proj1_badge: "Job cloud",
    proj1_title: "Generación de OCs - GCP Cloud Run",
    proj1_desc: "Moví la generación de órdenes de compra desde RPA hacia un Job de Cloud Run con .NET, CI/CD en Azure DevOps e integración con Microsoft Graph API. Entregado en <strong>2.5 semanas</strong>.",
    proj2_badge: "Control de riesgo",
    proj2_title: "Carga de Promociones - Validación de Reglas",
    proj2_desc: "Definí reglas y ruta de QA para un flujo de carga de promociones después de errores manuales que causaron ~S/ 200,000 en pérdidas.",
    proj3_badge: "OpenAI API",
    ...
    proj7_desc: "Construí y desplegué un SaaS full-stack para gestión de pagos en cuotas: <strong>React 18 + Node.js + PostgreSQL</strong> en <strong>Cloudflare Pages + GCP Cloud Run</strong>, con CI/CD y backups automáticos.",
    skills_tag: "Stack Real",
    skills_title: "Herramientas que puedo defender en entrevista",
