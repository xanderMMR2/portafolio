...
const translations = {
  en: {
    ...
    m1_detail: "Direct savings + risk mitigation combined",
    ...
    proj_tag: "Projects",
    proj_title: "Key <span class=\"gradient-text\">Projects</span>",
    ...
    proj7_desc: "Built and deployed a full-stack SaaS for installment payment management: <strong>React 18 + Node.js + PostgreSQL</strong> on <strong>Cloudflare Pages + GCP Cloud Run</strong>, with Cloud Build CI/CD pipeline and automated daily backups via GitHub Actions.",
  ...
  es: {
    ...
    hero_sub: "Licenciado en Ciencias de la Computación · Especialista en entrega acelerada de sistemas autónomos mediante orquestación de agentes, validación de soluciones (QA) e integración de sistemas. <strong>Éxito comprobado en la entrega de 13 soluciones de automatización de grado de producción.</strong>",
    ...
    m1_detail: "Ahorro directo + mitigación de riesgos combinados",
    m2_label: "Ahorro Directo Acumulado",
    m2_detail: "Ahorro bruto de 9 bots en producción",
    ...
    proj_tag: "Proyectos",
    proj_title: "Proyectos <span class=\"gradient-text\">Clave</span>",
    proj1_badge: "Cloud Native",
    ...
    proj7_desc: "Construí y desplegué un SaaS full-stack de gestión de ventas en cuotas: <strong>React 18 + Node.js + PostgreSQL</strong> en <strong>Cloudflare Pages + GCP Cloud Run</strong>, con pipeline CI/CD vía Cloud Build y backups automáticos diarios vía GitHub Actions.",
...
const setLanguage = (lang) => {
  ...
  if (cvLink) {
    cvLink.href = lang === 'en' ? 'pdfs-finales/CV-Alexander-Melendez-AI-Automation-Engineer-EN.pdf' : 'pdfs-finales/CV-Alexander-Melendez-AI-Automation-Engineer-ES.pdf';
  }
